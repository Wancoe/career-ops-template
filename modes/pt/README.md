...
Se a maioria das suas vagas e em ingles, fique com os modos padrao em `modes/`. Os modos em ingles funcionam automaticamente quando o assistente AI detecta uma vaga em portugues — mas nao conhecem as particularidades do mercado brasileiro no mesmo nivel de detalhe.
...
Diga ao assistente AI no inicio da sessao:
...
O assistente vai ler os arquivos desta pasta em vez de `modes/`.
...
Lembre o assistente AI na primeira sessao de respeitar esse campo ("Olha no `profile.yml`, eu configurei `language.modes_dir`"). A partir dai, ele usa automaticamente os modos em portugues.
...
| `pdf.md` | `modes/pdf.md` (EN) | Geração de CV/PDF ATS-friendly com foco em portfólio criativo |
